...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dmn.ucad.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dmn.ucad.repository.UserRepository.USERS_BY_EMAIL_CACHE);
