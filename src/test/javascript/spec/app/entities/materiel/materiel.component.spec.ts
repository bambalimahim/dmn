...
import { MaterielComponent } from 'app/entities/materiel/materiel.component';
...
describe('Component Tests', () => {
  describe('Materiel Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.materiels && comp.materiels[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
